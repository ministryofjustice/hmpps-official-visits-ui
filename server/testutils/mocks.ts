...
export const mockOfficialVisitors = [
  ...
  },
  {
    ...
    // @ts-expect-error - relationshipCode is not strictly in this type but returned from the API when getting a visit
    relationshipCode: 'SOC',
...
export const mockVisitByIdVisit: OfficialVisit = {
  ...
  visitorConcernNotes: 'visit level visitor concern notes',
  searchTypeCode: 'FULL',
