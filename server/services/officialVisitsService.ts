...
export default class OfficialVisitsService {
  ...
  public async getVisits(res: Response, prisonId: string, criteria: FindByCriteria, page: number, size: number) {
    ...
    return {
      content: mockContents.slice((page - 1) * size, page * size),
      page: {
...
// function tempGetRandomVisit(name: string) {
//   const statuses = ['Scheduled', 'Cancelled', 'Completed', 'Expired']
//   const types = ['In Person', 'Telephone', 'Video', 'Unknown']

//   return {
//     "officialVisitId": Math.floor(Math.random() * 1000),
//     "prisonCode": "MDI",
//     "prisonDescription": "Moorland (HMP & YOI)",
//     "visitStatus": "SCHEDULED",
//     "visitStatusDescription": statuses[Math.floor(Math.random() * statuses.length)],
//     "visitTypeCode": "IN_PERSON",
//     "visitTypeDescription": types[Math.floor(Math.random() * types.length)],
...
//     "numberOfVisitors": Math.floor(Math.random() * 10),
...
//     "prisoner": {
//       "prisonerNumber": Array.from({ length: 10 }, () => Math.floor(Math.random() * 10)).join(''),
//       "prisonCode": "string",
