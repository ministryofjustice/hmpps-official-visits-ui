    ...
    it('should render the official visit history timeline', async () => {
      ...
      await request(app)
        ...
        .expect(res => {
          ...
          expect($(subLine).eq(0).text()).toContain('visitor@example.com')
          ...
          expect($(description).text()).toContain('Reason: Confirmation email sent')
          ...
          expect($(description).text()).toContain('Reason: Temporary delivery failure')
    ...
    it('should safely handle unknown fields, whitespace values, and unexpected notification statuses', async () => {
      ...
      await request(app)
        ...
        .expect(res => {
          ...
          expect(bylines.join(' ')).toContain('Email notification status unknown')
          expect(bylines.join(' ')).toContain('System')
