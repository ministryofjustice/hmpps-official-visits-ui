  ...
  public GET = async (req: Request, res: Response) => {
    ...
    req.session.journey.officialVisit = {
      ...
      prisoner: {
        ...
        restrictions: [
          restrictions[0],
          { ...restrictions[0], restrictionType: 'NONCON', restrictionTypeDescription: 'Sample Tag' },
          { ...restrictions[0], restrictionType: 'ACC', restrictionTypeDescription: 'Sample Tag' },
          { ...restrictions[0], restrictionType: 'BAN', restrictionTypeDescription: 'Sample Tag' },
          { ...restrictions[0], restrictionType: 'CCTV', restrictionTypeDescription: 'Sample Tag' },
          { ...restrictions[0], restrictionType: 'CHILD', restrictionTypeDescription: 'Sample Tag' },
          { ...restrictions[0], restrictionType: 'DIHCON', restrictionTypeDescription: 'Sample Tag' },
          { ...restrictions[0], restrictionType: 'RESTRICTED', restrictionTypeDescription: 'Sample Tag' },
        ],
        alertsCount,
        restrictionsCount,
      },
